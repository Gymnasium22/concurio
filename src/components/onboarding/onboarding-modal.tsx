...
const STEPS = [
  {
    ...
    body: 'Пульт конкурсов и задач: на главной — что горит сегодня, этапы с датами, канбан и календарь.',
  },
  {
    title: 'Быстрый старт',
    body: 'Создайте через «+» и выберите шаблон (конкурс в 3 этапа, хакатон, курсовая). Даты этапов подставятся сами.',
  },
  {
    title: 'Главная = ваш день',
    body: 'Блок «Что делать дальше»: просрочено, сегодня, на проверке, скоро. Ниже — весь список. Можно делиться прогрессом ссылкой.',
  },
];
