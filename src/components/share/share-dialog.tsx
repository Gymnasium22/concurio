    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Выберите задачи — получите ссылку. Получатель увидит их{' '}
            <strong>без регистрации</strong>, только для просмотра. Редактировать
            и видеть остальные задачи он не сможет.
          </DialogDescription>
        </DialogHeader>
